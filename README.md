...
# ubuntu-iso-builder-respin-openbox
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-openbox](https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox.git
```


> change dir to `ubuntu-iso-builder-respin-openbox`

``` sh
cd ubuntu-iso-builder-respin-openbox
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-openbox/dist`
